...
Jlf = 8 #The Adhesion (contact energy) of leader cells and follower cells
mu = 21  #Chemotaxis Lambda
PP = 0.9 # the percentage of the follower cells allowed to proliferate
...
#======================================================================================================================================  
        ...
        for cell in self.cell_list_by_type(self.FC):
            if cell.id not in Tumorcells and cell.id not in cluster_checked:
                ...
                if len(new_cluster_cells) >= 2 and num_leader_cells >= 1:
