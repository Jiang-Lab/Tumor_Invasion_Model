...
Jlf = -5 #The Adhesion (contact energy) of leader cells and follower cells
mu = 30  #Chemotaxis Lambda
PP = 0 # the percentage of the follower cells allowed to proliferate
