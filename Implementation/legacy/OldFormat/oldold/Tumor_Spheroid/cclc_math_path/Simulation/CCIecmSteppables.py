...
class ConstraintInitializerSteppable(SteppableBasePy):
    ...
    def start(self):
        ...
        # Apply chemotaxis and adhesion values
        #mv = self.field.MV
        #for x in range(500):
            #for y in range(500):
                #g = 1  
...
class NeighborTrackerPrinterSteppable(SteppableBasePy):
    ...
    def step(self, mcs):
        ...
        xmin = float("inf")  # Set to infinity to ensure any cell's xCOM is smaller
        startcell = None  # Initialize as None
        ...
        if startcell is not None:
            ...
            print("Warning: No valid startcell found in surface. Skipping vsurface.append().")
       ...
       # stalks = len(endpoints)
        ...
        if mcs % 10 == 0:
            ...
            if boundary_points:
                ...
                # Filter turning points that meet the height requirement (y â‰¤ min_branch_height)
